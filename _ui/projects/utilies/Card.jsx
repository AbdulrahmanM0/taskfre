...
function Card({item}) {
    return (
        <div className='relative min-h-[140px] md:min-h-[110px] min-h-auto rounded-[12px] overflow-hidden p-clamp-10 flex flex-col'>
            <Image src={`/images/backdrops/${item}`} className='md:min-h-[110px] min-h-auto' fill alt="card" />
